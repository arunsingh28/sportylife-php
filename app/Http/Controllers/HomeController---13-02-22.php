...
class HomeController extends Controller
{
    ...
    public function profileEditPost(Request $request)
    {
        ...
        $input = $request->only('first_name', 'last_name', 'country_code', 'language_id', 'city', 'state', 'weight', 'weight_type', 'height_type', 'height_feet', 'height_inch', 'school_name', 'school_address','school_unique_id','zipcode');
    ...
    public function services()
    {
        ...
        $packagedata = Servicepackages::where('package_type', 'android')->where('status', '1')->where('id', '!=', '4')->where('parent_id', null)->get();
    ...
    {
        $blogs = News_feeds::where('status', '1')->get();
        foreach ($blogs as $key => $value) {
