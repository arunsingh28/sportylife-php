            ...
            <div class="col-lg-10 col-md-12">
                ...
                <div class="row Recipe">
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        @csrf
                            <div class="diet_chart">
                                <img src="{{asset('web/assets/img/cooking.png')}}" class="pro_pi meal_com_img">
                                <h3 data-toggle="modal" data-target="#exampleModal">Meals Completed</h3>
