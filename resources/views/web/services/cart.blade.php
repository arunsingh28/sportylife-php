               ...
               <form role="form" method="POST" action="{{ url('orderPlace') }}">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12 Product_del mt-2">
                        ...
                        <input name="click_type" id="click_type" type="hidden"  value="cart">                         
                        <input name="type" type="hidden"  value="sport">                         
                        <!-- <hr> -->
                        <ul class=" list-part">
                                 ...
                                 <div class="row">
                                    ...
                                    <!-- <div class="col-md-6">
                                       ...
                                       <div class="form-group" style="position: relative;">
                                          ...
                                          <input id="weight" type="text" name="weight"  class="form-control" pattern="[0-9]+" placeholder="Weight"
                                             required="required">
                                          <a href="#!">
                                    ...
                                    <!-- <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="height">
                                             ...
                                             <input style="margin-left: 28px !important;" pattern="[0-9]+"  class="otp" id="height_feet" name="height_feet"  type="text" placeholder="cm" maxlength="15">
       ...
       $.ajax({
           ...
           success: function(data){
            if (data.statusCode == "200") {
                  ...
                  //    $("#listhtml"+package_id).append('<li class="list-group-item"><label>'+(key1)+'. '+value.person_first_name+' '+value.person_last_name+'</label>  <span ><i style="float: right;" class="fa fa-trash" onclick="removePerson('+value.id+','+package_id+','+cart_id+')"></i></span></li>');
                  // });
                  location.reload(true);
            }else{
                  toastr.error(data.message)
