      ...
      <div class="row">
         ...
         <div class="col-lg-8 col-md-12">
            ...
            <div class="cont_sec">
               <form role="form" method="POST" action="{{ url('orderPlace') }}">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12 Product_del mt-2">
                        ...
                        <input name="click_type" id="click_type" type="hidden"  value="buynow">        
                        ...
                        <ul class=" list-part">
                           ...
                           <input id="parent_package_id" name="store[{{$key1}}][parent_package_id]" type="hidden"  value="{{$item1['parent_package_id']}}">
                           @if($type == "addon_sport" || $type == "addon_person")
                              <input  name="parent_package_id" type="hidden"  value="{{$item1['parent_package_id']}}">
                           ...
                           <div class="sort_menu mb-3"  style="border: 1px solid gray !important;padding: 13px !important;border-radius: 11px !important;">
                              ...
                              <hr>
                              @if($type == "addon_sport" || $type == "sport")
                              @if($item1->packagedata->is_sports_show == '1')
                              <div class="col-md-12 Product_del" style="margin-top: -21px !important;">
                                 <div class="row" style="background: #373737;padding: 0px;border-radius: 11px; width: 100%;">
                                    <div class="col-md-6">
                                       <h6 style="padding-bottom: 10px !important;margin: 9px auto 0 !important;float: left !important;">Sports List</h6>
                                    </div>
                                    <div class="col-md-6">
                                       {{-- <span class="badge sport-add-btn" style="color: white;border-radius: 4px;background: #212121;font-weight: 400;float: right;margin-top: 7px;" data-toggle="modal" data-target="#addsportModal{{$item1['package_id']}}">Add/Edit Sport</span> --}}
                                    </div>
                                 </div>
                                 <div id="sort_menu{{$key1+1}}" data-sort_menu_id="{{$item1['id']}}" class="sort_menu mt-2"  >
                                    ...
                                    <li class="list-group-item"  data-id="{{$item->id}}">
                                       ...
                                       <span class="badge" style="border-radius: 4px;padding: 2px 3px 2px 3px;font-weight: 700;float: right;    margin-top: 4px;">
                              ...
                              @if($type == "addon_person" || $type == "sport")
                                 ...
                                 <div class="col-md-12 Product_del" style="margin-top: -21px !important;">
                                    <div class="row" style="background: #373737;padding: 0px;border-radius: 11px; width: 100%;">
                                       ...
                                       <div class="col-md-6 ">
                                          <!-- <span class="badge sport-add-btn" style="color: white;border-radius: 4px;background: #212121;font-weight: 400;float: right;margin-top: 7px;" >Add Person</span> -->
                                          <span class="badge sport-add-btn" style="color: white;border-radius: 4px;background: #212121;font-weight: 400;float: right;margin-top: 7px;" data-toggle="modal" data-target="#personaddon{{$item1['package_id']}}">Add Person</span>
                                       </div>
                                    </div>
                                    <ul class=" list-part mt-2" id="listhtml{{$item1['package_id']}}">
                                          ...
                                          <li class="list-group-item">
                                             <span ><i class="fa fa-trash" onclick="removePerson(<?php echo $item->id; ?>,<?php echo $item1['package_id']; ?>,<?php echo $item1['id']; ?>)"></i></span>
                                             <label style="margin-left: 10px;">{{$key+1}}. {{$item->person_first_name.' '.$item->person_last_name}}
                                                <span class="badge" style="background: #373737;border-radius: 4px;padding: 2px 3px 2px 3px;font-weight: 700;float: right;margin-top: 3px;margin-left: 10px;">{{ucfirst($item->addon_type)}}</span>
                                             </label>  
                                             <span class="badge" style="border-radius: 4px;padding: 2px 3px 2px 3px;font-weight: 700;float: right;margin-top: 4px;">&#x20B9; {{$item->person_price}}</span>
                                          </li>
                                          @endforeach
                                          @else
                        ...
                        <div class="row">
                           <div class="col-md-6 mb-2">
                              <a href="{{route('services')}}">
                                 <input type="button" class="btn-send " style="background: #212121 !important;color: #fff !important;" value="Continue Shopping">
                              </a>
                           </div>
                           <div class="col-md-6">
                  ...
                  <div class="modal-dialog" style="margin-top: 12%;" >
                     <div class="modal-content" style="background-color: #323232 !important;">
                        ...
                        <div class="modal-footer">
                           <p id="errorTextaddSport" style="color:white;"></p>
               ...
               @if($item1->packagedata['addon_adult_count'] > 0 || $item1->packagedata['addon_kid_count'] > 0 )
               <div class="modal fade personmodal" id="personaddon{{$item1['package_id']}}"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
                  <div class="modal-dialog persion-list" style="margin-top: 12%;" >
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="cont_sec" style="padding: 20px !important;border: 0px solid #707070 !important;">
                              ...
                              <div class="mb-2">
                                 <input type="radio" id="existing_user" name="member_type" value="existing" onclick="show1();"> <label for="existing_user" style="color: #fff;">&nbsp;Existing User &nbsp;&nbsp;&nbsp;</label><br>
                                 <input type="radio" id="new_user" name="member_type" value="new" onclick="show2();"> <label for="new_user" style="color: #fff;">&nbsp;New User</label>
                              </div>
                              <div  id="existinguserlistdiv" style="display:none">
                                 <div class="row" >
                                    {{-- <div class="col-md-6">
                                       <div class="form-group">
                                          <h6 class="hgt_sec">Select User</h6>
                                          <select class="one mb-0 mt-0 newuser js-example-basic-single" id="existing_userid" name="existing_userid" onchange="getUserDob(this.value)">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <h6 class="hgt_sec">Select User</h6>
                                          <input type="text" class="form-control newuser"   id="existing_userlist" placeholder="Type User Name here"/>
                                          <input type="hidden" class="form-control newuser" oninput="getUserDob(this.value)" name="existing_userid" id="existing_userid" placeholder="Type User Name here"/>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <!-- <div id="newuserdiv" > -->
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">First Name</h6>
                                       <div class="form-group">
                                          <input id="person_first_name" type="text" name="person_first_name" class="form-control newuser" placeholder="First Name" required="required">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">Last Name</h6>
                                       <div class="form-group">
                                          <input id="person_last_name" type="text" name="person_last_name" class="form-control newuser" placeholder="Last Name"
                                             required="required">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">Email</h6>
                                       <div class="form-group">
                                          <input id="person_email" type="email" name="person_email" class="form-control newuser" placeholder="Email ID"
                                             required>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">Phone</h6>
                                       <div class="form-group">
                                          <input id="person_phone" type="text" name="person_phone" class="form-control newuser" placeholder="Phone"
                                             required>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">Date Of Birth</h6>
                                       <div class="form-group">
                                          <input id="dob" type="text" name="dob" onchange="checkPersonType(this.value);"  class="form-control newuser" placeholder="dd-mm-yyyy" required="required" autocomplete="off">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">Gender</h6>
                                       <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                       <h6 class="hgt_sec">Password</h6>
                                       <div class="form-group" style="position: relative;">
                                          <input id="password" type="password" name="password"  class="form-control newuser" placeholder="Password"
                                             required="required">
                                             <h6 class="kg"  onclick="showpassword()" id="eyeopt" style="top: 7px !important;"><i  class="fa fa-eye-slash" style="margin-left: 32%;"></i></h6>      
                                       </div>
                                    </div>
                                    <!-- <div class="col-md-6">
                                       <div class="form-group" >
                                    ...
                                    <!-- <div class="col-md-6">
                                       ...
                                       <div class="form-group" style="position: relative;">
                                          <input id="weight_type" type="hidden" name="weight_type" value="Kilogram">
                                          <input id="weight" type="text" name="weight" pattern="[0-9]+" class="form-control" placeholder="Weight" required="required">
                                          <a href="#!">
                                             <h6 class="kg" style="top:7px !important;">&nbsp;&nbsp;&nbsp;KG</h6>
                                          </a>
                                       </div>
                                    </div> -->
                                    <!-- <div class="col-md-6">
                                    ...
                                    <!-- <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="height">
                                             <input type="hidden" name="height_type" id="height_type" value="Centimeter">
                                             <input style="margin-left: 28px !important;" class="otp" pattern="[0-9]+" id="height_feet" name="height_feet"  type="text" placeholder="cm" maxlength="15">
                                             <input  class="otp" id="height_inch" name="height_inch" pattern="[0-9]+"  style="border-right: none;" type="text"  placeholder="mm" maxlength="15">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                              ...
                              <!-- <div id="relationdiv" > -->
                                 <div class="row">
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                          <input id="relation" type="text" name="relation"  class="form-control newuser" placeholder="Relation"
                                             required="required">
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="modal-footer">
                           <p id="errorTextaddPerson" style="color:white;"></p>
                           <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Close</button>
                           <button type="button" class="btn btn-sm btn-secondary" onclick="addPerson(<?php echo $item1['package_id'];?>,<?php echo $item1['id']; ?>,<?php echo $item1['parent_package_id']; ?>);">Add</button>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
   ...
   var userArray = $.map(users, function (value, key) { return { value: value.name, data: value.id }; });
// Initialize ajax autocomplete:
$('#existing_userlist').autocomplete({
    ...
    onSelect: function(suggestion) {
      ...
      $('#existing_userid').val(suggestion.data);
      getUserDob(suggestion.data)
   ...
   function showpassword() {
            ...
            if (x.type === "password") {
               x.type = "text";
               $("#eyeopt").html("<i class='fa fa-eye' style='margin-left: 30%;'></i>")
            } else {
               x.type = "password";
   ...
   function show1(){
      ...
      document.getElementById('existinguserlistdiv').style.display ='block';
      document.getElementById('relationdiv').style.display ='block';
   }
   function show2(){
      emptyval();
      document.getElementById('newuserdiv').style.display = 'block';
      document.getElementById('existinguserlistdiv').style.display ='none';
      document.getElementById('relationdiv').style.display ='block';
   }
...
<script>
       ...
       $.ajax({
           ...
           success: function(data){
            if (data.statusCode == "200") {
                  ...
                  // window.location.href = "{{url('buynow')}}";
   ...
   function addPerson(package_id,cart_id,parent_package_id) {
      
      var member_type = $('input[name="member_type"]:checked').val();
      // var member_type = "new";
      var existing_userid = $("#existing_userid").val();
      ...
      var parent_package_id = parent_package_id;
      var cart_id = cart_id;
       ...
       $.ajax({
           ...
           success: function(data){
            if (data.statusCode == "200") {
                  ...
                  //    $("#listhtml"+package_id).append('<li class="list-group-item"><span ><i style="" class="fa fa-trash" onclick="removePerson('+value.id+','+package_id+','+cart_id+')"></i></span><label style="margin-left: 13px;">'+(key1)+'. '+value.person_first_name+' '+value.person_last_name+'</label>  <span class="badge" style="border-radius: 4px;padding: 2px 3px 2px 3px;font-weight: 700;float: right;margin-top: 4px;">&#x20B9; '+value.person_price+'</span></li>');
                  // });
                  location.reload(true);
            }else{
                  toastr.error(data.message)
                  // $('#personaddon').modal('show');
                  $('#errorTextaddPerson').html(data.message).css('color','red');
               }
            },
            error: function(){
