    ...
    <section id="pricing" class="pricing free_trial">
        <div class="container">
            ...
            <div class="w-full  border rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700" style="background:#646a8e;">
                ...
                <ul class="hidden text-sm font-medium text-center text-white divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist" style="background:#646a8e;">
                    <li class="w-full">
