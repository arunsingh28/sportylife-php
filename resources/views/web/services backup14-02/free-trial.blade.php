        ...
        <div class="row">
            ...
            <form role="form" method="POST" action="{{ url('startFreeTrial') }}">
                ...
                @if($user->is_active_freetrial == "1" || $user->is_complete_freetrial == "1")
                    <div class="row mt-5">
                        <div class="col-md-6">
                            <a href="{{route('live-sessions')}}"><img src="{{asset('web/assets/img/liv-seson.png')}}" style="width: -webkit-fill-available;"></a>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12 col-md-6 portfolio-item1 " style="text-align: center;">
                            ...
                            <img src="{{asset('web/assets/img/work-out.jpg')}}" style="width: 49%!important;height: 57%!important;object-fit: cover;border-radius: 13px !important;" class="img-fluid" alt="">
