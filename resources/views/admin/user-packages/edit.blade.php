                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                           ...
                           <br>
                           @if($data->type == 'image')
                                <img alt="{{$data->title}}" src="{{asset($data->uploads)}}" height="50">
                            @else
                     ...
                     <div class="col-lg-3">
                        <div class="form-group">
                           ...
                           <input type="text" name="calorie" value="{{$data->calorie}}" class="form-control" placeholder="Calorie" required>
                        </div>
                     </div>
                     <div class="col-lg-3">
                        <div class="form-group">
                           <label class="form-control-label" >Protein</label>
                           <input type="text" name="protein" value="{{$data->protein}}" class="form-control" placeholder="Protein" required>
                        </div>
                     </div>
                     <div class="col-lg-3">
                        <div class="form-group">
                           <label class="form-control-label" >Carbs</label>
                           <input type="text" name="carbs" value="{{$data->carbs}}" class="form-control" placeholder="Carbs" required>
                        </div>
                     </div>
                     <div class="col-lg-3">
                        <div class="form-group">
                           <label class="form-control-label" >Fats</label>
                           <input type="text" name="fats" value="{{$data->fats}}" class="form-control" placeholder="Fats" required>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="form-group">
