...
@section('content')
    ...
    $errors->all('
                    ...
                    @endif
                    <form method="post" action="{{ route('service-packages-ios-update') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="discount" onkeyup="updateFinalAmount()" id="discount"
                                            ...
                                            class="form-control" placeholder="Enter Discount" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ios_package_id"
                                            ...
                                            class="form-control" placeholder="IOS Package Number" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label">Duration Type</label>
                                        <select name="duration_type" class="form-control" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="package_duration"
                                            ...
                                            min="1" class="form-control" placeholder="Package Duration" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="package_tag"
                                            ...
                                            placeholder="Package Tag" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sports_count"
                                            ...
                                            class="form-control" placeholder="Sports Count" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6" id="addon_price_type_div" style="<?php if (empty($data->parent_id)) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="addon_price_type" class="form-control" readonly>
                                ...
                                <div class="col-lg-6" id="addon_adult_count_div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="addon_adult_count" id="addon_adult_count"
                                            ...
                                            class="form-control" placeholder="Addon Adult Count" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6" id="addon_kid_count_div">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="addon_kid_count" id="addon_kid_count"
                                            ...
                                            class="form-control" placeholder="Addon Kid Count" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="validity_extend"
                                            ...
                                            min="0" class="form-control" placeholder="Validity Extend" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
