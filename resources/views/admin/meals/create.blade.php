                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="frequency_id" id="" class="form-control js-example-basic-single">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="calorie" id="calorie"  class="form-control" placeholder="Calories" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" >Protein</label>
                                        <input type="text" name="protein" id="protein"  class="form-control" placeholder="Protein" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" >Carbs</label>
                                        <input type="text" name="carbs" id="carbs"  class="form-control" placeholder="Carbs" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" >Fat</label>
                                        <input type="text" name="fats" id="fats"  class="form-control" placeholder="Fat" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
