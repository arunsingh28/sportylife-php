      ...
      <div class="card">
         <div class="card-header">
            <div class="row align-items-center">
               <div class="col-8">
                  <h3 class="mb-0">Home Category Add</h3>
               </div>
         ...
         <div class="card-body">
            <form method="post" action="{{route('home-category-add')}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                           ...
                           <span style="color:red;">Image Size should be 1200px*630px</span>
                        </div>
                     </div>
                  </div>
