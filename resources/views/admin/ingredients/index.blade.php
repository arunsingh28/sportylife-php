            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Ingredients List </h3>
                        </div>
                        <div class="col-4 text-right">
                            @if(auth()->user()->role_id == "1"  || auth()->user()->role_id == "10") 
                            <a href="{{route('ingredients-add')}}"
                        ...
                        @foreach($data as $key => $item )
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('/admin/ingredients-edit',$item->id)}}"
                                    class="btn btn-sm btn-primary">Edit</a>
                                    @endif
                                    @if(auth()->user()->role_id == "1" || auth()->user()->role_id == "10" || $roles_data->type == "new") 
                                    <a href="{{url('/admin/ingredients-delete',$item->id)}}"
        ...
        $(function () {
            $('#myTable').on('change', 'tbody input.changestatus', function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("/admin/change-ingredients-status")}}',
